...
@IncludeClassNamePatterns(
    "^.*Test.*$") // Change defaults class name filter to any name containing "Test"
@IncludeTags("UsingHamcrest") // Filter out those classes that do not have that tag
public
class AlltestsUsingSelectPackageAndTagFilter { // Class name uses by intention lower case "test" to
